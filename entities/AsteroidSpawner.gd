...
func _set_asteroid_trajectory(asteroid):
	...
	asteroid.angular_damp = 0 # slowing spin (angular velocity)
	asteroid.linear_velocity = Vector2(rand_range(-300, 300), 300) # random direction
